      ...
      <div class='row gutters'>
        <div class='col desc'>
          <p class='error'>
            ...
            <a target='_blank' href='https://developers.arcgis.com/documentation/core-concepts/security-and-authentication/limitations-of-application-authentication/'>here</a>).
            You can generate your own client id by creating an application on the
            <a target='_blank' href='https://developers.arcgis.com/'>ArcGIS for Developers</a> site.
            Be sure to add <code>{{ redirect_uri }}</code> as a redirect uri for your application.
          </p>
        </div>
      </div>
    </fieldset>
